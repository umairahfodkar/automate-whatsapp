...
cluster = MongoClient("mongodb+srv://umairahfodkar:umairahfodkar@cluster0.baiyxz1.mongodb.net/?retryWrites=true&w=majority")
db = cluster["bakery"]
users = db["users"]
orders = db["orders"]
...
def reply():
    ...
    if bool(user) == False:
        msg = res.message("Hi, thanks for contacting *Lenskart*.\nYou can choose from one of the options below: "
